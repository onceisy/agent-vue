...
export const needAddAsyncRoutes = [
  // Agent管理
  {
    path: "/agentService",
    name: "agentManager",
    meta: {
      title: "menus.agentManager",
      icon: "agentguanli"
    },
    children: [
      {
  ...
  // 数据分析
  {
    ...
    children: [
      {
        path: "/dataAnalysis/sessionLog/index",
        name: "sessionLog",
        meta: {
          title: "menus.sessionLog",
...
function handleAsyncRoutes(routeList = []) {
  routeList.push(...needAddAsyncRoutes);
